...
目前版本已完成可落地的網站、資料庫、相機頁面、OCR 文字讀取、公開資料查詢、文字規則分析與資料分析。未來可加入圖像分類模型，讓系統更自動地判斷鏡頭畫面中的物品。
...
- 圖像分類：目前先實作棕色紙箱 / 瓦楞紙板的像素顏色啟發式判斷，未來可擴充寶特瓶、鋁箔包、紙餐盒、鐵鋁罐等物品。
